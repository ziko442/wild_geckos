            ...
            <div className="nk-block nk-block-about">
                <div className="row justify-content-between align-items-center gutter-vr-50px">
                    <div className="col-lg-6">
                        <div className="nk-block-text">
                            <div className="nk-block-text-head">
                                <h2 className="title title-lg ttu animated" data-animate="fadeInUp"
                                    data-delay="0.7">Contact Us</h2>
                                <p className="animated tc-white" data-animate="fadeInUp" data-delay="0.8">We are
                                    always open and we welcome and questions you have for our team. If you wish
                                    to get in touch, please fill out the form below. Someone from our team will
                                    get back to you shortly.</p>
                            </div>
                            <form className="nk-form-submit tc-white" action="form/contact.php" method="post">
                                <div className="row">
                                    <div className="col-sm-6">
                                        <div className="field-item animated" data-animate="fadeInUp"
                                            data-delay="0.8">
                                            <label className="field-label ttu">Your Name</label>
                                            <div className="field-wrap">
                                                <input name="contact-name" placeholder="Introduce yourself"
                                                    type="text" className="input-bordered required"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-sm-6">
                                        <div className="field-item animated" data-animate="fadeInUp"
                                            ...
                                            <div className="field-wrap">
                                                <input name="contact-email" placeholder="Who do we replay to"
                                                    type="email" className="input-bordered required email"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="field-item animated" data-animate="fadeInUp" data-delay="1.0">
                                    ...
                                    <div className="field-wrap">
                                        <textarea name="contact-message"
                                            ...
                                            className="input-bordered input-textarea required"></textarea>
                                    </div>
                                </div>
                                <input type="text" className="d-none" name="form-anti-honeypot" value=""/>
                                <div className="row">
                                    <div className="col-sm-5 text-right animated" data-animate="fadeInUp"
                                        data-delay="1.1">
                                        <button type="submit" className="btn btn-round btn-send">SEND</button>
                                    </div>
                    ...
                    <div className="col-lg-5 text-center order-lg-first">
                        <div className="nk-block-contact nk-block-contact-s1  animated" data-animate="fadeInUp"
                            data-delay="0.1">
                            <ul className="contact-list tc-white">
                        ...
                        <ul className="social-links social-links-s2 justify-content-center animated"
