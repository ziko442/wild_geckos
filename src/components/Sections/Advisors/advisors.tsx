            ...
            <div className="row justify-content-center text-center">
                <div className="col-lg-6">
                    <div className="section-head section-head-s2">
                        <h2 className="title title-xl animated" data-animate="fadeInUp" data-delay="0.1" title="Advisors">BOARD MEMBER</h2>
                        <p className="animated" data-animate="fadeInUp" data-delay="0.2">Our advisors and board members are great part of our team.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="nk-block nk-block-sm">
                <div className="row">
                    <div className="col-md-4 col-lg-2 col-6">
                        <div className="team team-s2 team-sm-s2 team-odd animated" data-animate="fadeInUp" data-delay="0.3">
                    ...
                    <div className="col-md-4 col-lg-2 col-6">
                        <div className="team team-s2 team-sm-s2 team-even animated" data-animate="fadeInUp" data-delay="0.35">
                            <div className="team-photo team-photo-s2">
                    ...
                    <div className="col-md-4 col-lg-2 col-6">
                        <div className="team team-s2 team-sm-s2 team-odd animated" data-animate="fadeInUp" data-delay="0.4">
                            <div className="team-photo team-photo-s2">
                    ...
                    <div className="col-md-4 col-lg-2 col-6">
                        <div className="team team-s2 team-sm-s2 team-even animated" data-animate="fadeInUp" data-delay="0.45">
                            <div className="team-photo team-photo-s2">
                    ...
                    <div className="col-md-4 col-lg-2 col-6">
                        <div className="team team-s2 team-sm-s2 team-odd animated" data-animate="fadeInUp" data-delay="0.5">
                            <div className="team-photo team-photo-s2">
                                <img src="images/azalea/team-b.jpg" alt=""/>
                            </div>
                    ...
                    <div className="col-md-4 col-lg-2 col-6">
                        <div className="team team-s2 team-sm-s2 team-even animated" data-animate="fadeInUp" data-delay="0.55">
                            <div className="team-photo team-photo-s2">
                                <img src="images/azalea/team-c.jpg" alt=""/>
                            </div>
